...
import {
    ...
    Printer, Download, Search, X, Check, Truck, Edit2, Coins
} from "lucide-react";
...
export default function QuoteForm({ initialId }: { initialId?: string }) {
    ...
    return (
        <div className="max-w-6xl mx-auto space-y-8 animate-in fade-in pb-20">
            {/* Wizard Header */}
            <div className="flex justify-between items-center mb-8 bg-card p-4 rounded-xl border border-border shadow-sm">
                {STEPS.map((step, idx) => (
                    <div
                        key={step.number}
